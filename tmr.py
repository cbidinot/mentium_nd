...
class TMRNoiseConfig: 
    def __init__(self, noise_sd: float, noise_inference : bool = True, noise_training: bool = False, add_one_time_noise: bool = False, add_quantization: bool = False, quantize_fn: callable = None, quantize_kwargs = None,
        include_name_contains: Optional[Iterable[str]] = None, exclude_name_contains: Optional[Iterable[str]] = None, one_time_sd: float = 0.0):
        self.noise_sd1 = noise_sd
        self.noise_sd2 = noise_sd
        self.noise_sd3 = noise_sd
        self.one_time_sd = one_time_sd
...
def run_with_tmr(model: nn.Module, test_loader: DataLoader, device: torch.device, noise_config: TMRNoiseConfig) -> Dict[str, float]:
    """
    ...
    hart1 = noise.clone_with_noisy_layers(model, one_time_noise_sd=noise_config.one_time_sd, layer_noise_sd=noise_config.noise_sd1, add_one_time_noise=noise_config.add_one_time_noise, add_quantization=noise_config.add_quantization, quantize_fn=noise_config.quantize_fn, quantize_kwargs=noise_config.quantize_kwargs, include_name_contains=noise_config.include_name_contains, exclude_name_contains=noise_config.exclude_name_contains)
    hart2 = noise.clone_with_noisy_layers(model, one_time_noise_sd=noise_config.one_time_sd, layer_noise_sd=noise_config.noise_sd2, add_one_time_noise=noise_config.add_one_time_noise, add_quantization=noise_config.add_quantization, quantize_fn=noise_config.quantize_fn, quantize_kwargs=noise_config.quantize_kwargs, include_name_contains=noise_config.include_name_contains, exclude_name_contains=noise_config.exclude_name_contains)
    hart3 = noise.clone_with_noisy_layers(model, one_time_noise_sd=noise_config.one_time_sd, layer_noise_sd=noise_config.noise_sd3, add_one_time_noise=noise_config.add_one_time_noise, add_quantization=noise_config.add_quantization, quantize_fn=noise_config.quantize_fn, quantize_kwargs=noise_config.quantize_kwargs, include_name_contains=noise_config.include_name_contains, exclude_name_contains=noise_config.exclude_name_contains)
